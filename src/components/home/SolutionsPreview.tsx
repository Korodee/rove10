      ...
      <Container>
        <AnimatedSection>
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
            <h2 className="max-w-3xl text-[1.75rem] font-extrabold leading-[1.18] tracking-tight text-textDark md:text-4xl lg:text-[2.5rem]">
        ...
        <StaggerContainer className="mt-12 grid gap-6 sm:grid-cols-2 lg:mt-14 lg:gap-8">
              ...
              >
                <div className="relative flex min-h-[200px] items-center justify-center px-6 py-8 md:min-h-[240px] md:px-8 md:py-10">
                  <Image
                    ...
                    className="h-auto max-h-[160px] w-full max-w-[92%] object-contain md:max-h-[200px]"
                  />
                </div>
